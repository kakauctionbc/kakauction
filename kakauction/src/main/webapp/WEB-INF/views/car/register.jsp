...
<body>
<form id="registerCar" name="registerCar" method="post" action="<c:url value='/car/register.do'/>">
	<div id="Content">
		<h3>국산차 등록</h3>
		<div>
			<div class="title">
			...
			<table summary="판매자정보 입력" id="memberInfoTable">
				...
				<tr>
					...
					<th scope="col">아이디</th>
					<td>
						<input type="text" name="memberId" id="memberId" value="starstar16" readonly>
					</td>
				</tr>
				<tr>
					<th scope="col">주소</th>
		...
		<div>
			...
			<tr>
				<td class="option_inout">
					<ul>
						<li><input type="checkbox" id="options_95" name="options[]" value="95"> <label for="options_95">파워윈도우</label></li>
						...
						<li><input type="checkbox" id="options_98" name="options[]" value="98"> <label for="options_98">좌/우독립에어컨</label></li>
						<li><input type="checkbox" id="options_99" name="options[]" value="99"> <label for="options_99">가죽시트</label></li>
						<li><input type="checkbox" id="options_100" name="options[]" value="100"> <label for="options_100">열선시트</label></li>
						<li><input type="checkbox" id="options_101" name="options[]" value="101"> <label for="options_101">통풍시트</label></li>
						<li><input type="checkbox" id="options_102" name="options[]" value="102"> <label for="options_102">마사지시트</label></li>
						<li><input type="checkbox" id="options_103" name="options[]" value="103"> <label for="options_103">버켓시트</label></li>
						<li><input type="checkbox" id="options_104" name="options[]" value="104"> <label for="options_104">메모리시트</label></li>
						...
						<li><input type="checkbox" id="options_109" name="options[]" value="109"> <label for="options_109">알루미늄휠</label></li>
				...
				<td class="option_con">
					<ul>
						<li><input type="checkbox" id="options_38" name="options[]" value="38"> <label for="options_38">썬루프</label></li>
						<li><input type="checkbox" id="options_39" name="options[]" value="39"> <label for="options_39">파노라마썬루프</label></li>
						<li><input type="checkbox" id="options_40" name="options[]" value="40"> <label for="options_40">HID/제논램프</label></li>
						<li><input type="checkbox" id="options_41" name="options[]" value="41"> <label for="options_41">오토라이트</label></li>
						<li><input type="checkbox" id="options_42" name="options[]" value="42"> <label for="options_42">스마트키</label></li>
						<li><input type="checkbox" id="options_43" name="options[]" value="43"> <label for="options_43">엔진스타트버튼</label></li>
						<li><input type="checkbox" id="options_44" name="options[]" value="44"> <label for="options_44">라이트세척장치</label></li>
						<li><input type="checkbox" id="options_45" name="options[]" value="45"> <label for="options_45">주차조향보조시스템</label></li>
						<li><input type="checkbox" id="options_46" name="options[]" value="46"> <label for="options_46">전자주차브레이크</label></li>
						...
						<li><input type="checkbox" id="options_53" name="options[]" value="53"> <label for="options_53">크루즈컨트롤</label></li>
						<li><input type="checkbox" id="options_54" name="options[]" value="54"> <label for="options_54">에어서스펜션</label></li>
						<li><input type="checkbox" id="options_55" name="options[]" value="55"> <label for="options_55">전동트렁크</label></li>
						<li><input type="checkbox" id="options_56" name="options[]" value="56"> <label for="options_56">타이어공기압경보</label></li> 
					</ul>
				</td>
				<td class="option_con">
					<ul> 
						<li><input type="checkbox" id="options_57" name="options[]" value="57"> <label for="options_57">파워핸들</label></li>
						<li><input type="checkbox" id="options_58" name="options[]" value="58"> <label for="options_58">히팅핸들</label></li>
						<li><input type="checkbox" id="options_59" name="options[]" value="59"> <label for="options_59">리모컨핸들</label></li>
						<li><input type="checkbox" id="options_60" name="options[]" value="60"> <label for="options_60">가죽/우드핸들</label></li>
						<li><input type="checkbox" id="options_61" name="options[]" value="61"> <label for="options_61">속도감응식핸들</label></li>
						<li><input type="checkbox" id="options_62" name="options[]" value="62"> <label for="options_62">원격시동장치</label></li>
						<li><input type="checkbox" id="options_63" name="options[]" value="63"> <label for="options_63">무선도어리모컨</label></li>
						<li><input type="checkbox" id="options_64" name="options[]" value="64"> <label for="options_64">유아시트고정장치</label></li>
						<li><input type="checkbox" id="options_65" name="options[]" value="65"> <label for="options_65">패들쉬프트</label></li>
						...
						<li><input type="checkbox" id="options_68" name="options[]" value="68"> <label for="options_68">자동슬라이딩도어</label></li>
						<li><input type="checkbox" id="options_69" name="options[]" value="69"> <label for="options_69">전동접이식미러</label></li>
						<li><input type="checkbox" id="options_70" name="options[]" value="70"> <label for="options_70">냉장고</label></li>
						<li><input type="checkbox" id="options_71" name="options[]" value="71"> <label for="options_71">루프캐리어</label></li>
						...
						<li><input type="checkbox" id="options_74" name="options[]" value="74"> <label for="options_74">전동햇빛가리개</label></li>
						<li><input type="checkbox" id="options_75" name="options[]" value="75"> <label for="options_75">레인센서와이퍼</label></li> 
					</ul>
				</td>
				<td class="option_safe">
					<ul>
						<li><input type="checkbox" id="options_76" name="options[]" value="76"> <label for="options_76">운전석에어백</label></li>
						<li><input type="checkbox" id="options_77" name="options[]" value="77"> <label for="options_77">동승석에어백</label></li>
						<li><input type="checkbox" id="options_78" name="options[]" value="78"> <label for="options_78">측면에어백</label></li>
						<li><input type="checkbox" id="options_79" name="options[]" value="79"> <label for="options_79">커튼에어백</label></li>
						<li><input type="checkbox" id="options_80" name="options[]" value="80"> <label for="options_80">승객감지에어백</label></li>
						<li><input type="checkbox" id="options_81" name="options[]" value="81"> <label for="options_81">무릎보호에어백</label></li>
						<li><input type="checkbox" id="options_82" name="options[]" value="82"> <label for="options_82">액티브헤드레스트</label></li>
						<li><input type="checkbox" id="options_83" name="options[]" value="83"> <label for="options_83">ABS</label></li>
						...
						<li><input type="checkbox" id="options_88" name="options[]" value="88"> <label for="options_88">TCS</label></li>
						<li><input type="checkbox" id="options_89" name="options[]" value="89"> <label for="options_89">VDC/ESP</label></li>
						<li><input type="checkbox" id="options_90" name="options[]" value="90"> <label for="options_90">전,측면감지센서</label></li>
						<li><input type="checkbox" id="options_91" name="options[]" value="91"> <label for="options_91">후방감지센서</label></li>
						<li><input type="checkbox" id="options_92" name="options[]" value="92"> <label for="options_92">전방카메라</label></li>
						<li><input type="checkbox" id="options_93" name="options[]" value="93"> <label for="options_93">후방카메라</label></li>
						<li><input type="checkbox" id="options_94" name="options[]" value="94"> <label for="options_94">차선이탈경보장치</label></li>
					</ul>
				</td>
				<td class="option_aa">
					<ul>
						...
						<li><input type="checkbox" id="options_118" name="options[]" value="118"> <label for="options_118">블루투스</label></li>
						<li><input type="checkbox" id="options_119" name="options[]" value="119"> <label for="options_119">CD플레이어</label></li>
						...
						<li><input type="checkbox" id="options_125" name="options[]" value="125"> <label for="options_125">AUX</label></li>
						<li><input type="checkbox" id="options_126" name="options[]" value="126"> <label for="options_126">USB</label></li>
						<li><input type="checkbox" id="options_127" name="options[]" value="127"> <label for="options_127">아이팟단자</label></li>
						<li><input type="checkbox" id="options_128" name="options[]" value="128"> <label for="options_128">앞좌석TV</label></li>
						<li><input type="checkbox" id="options_129" name="options[]" value="129"> <label for="options_129">뒷좌석TV</label></li>  
				...
				<td class="option_tune">
					<ul>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_133" value="133"> <label for="options_133">흡기</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_134" value="134"> <label for="options_134">배기</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_135" value="135"> <label for="options_135">미션</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_136" value="136"> <label for="options_136">핸들</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_137" value="137"> <label for="options_137">계기판</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_138" value="138"> <label for="options_138">ECU맵핑</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_139" value="139"> <label for="options_139">터보차저</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_140" value="140"> <label for="options_140">슈퍼차저</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_141" value="141"> <label for="options_141">다운스프링</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_142" value="142"> <label for="options_142">일체형쇼바</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_143" value="143"> <label for="options_143">NA튜닝</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_144" value="144"> <label for="options_144">오디오</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_145" value="145"> <label for="options_145">스트럿바</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_146" value="146"> <label for="options_146">스테빌라이저</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_147" value="147"> <label for="options_147">엔진스왑</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_148" value="148"> <label for="options_148">브레이크</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_149" value="149"> <label for="options_149">스포일러</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_150" value="150"> <label for="options_150">휠/타이어</label></li>
               		<li style="width:97px"><input type="checkbox" name="options[]" id="options_151" value="151"> <label for="options_151">에어로파츠</label></li>
               	</ul>
				</td>
			</tr>
			</tbody>
