...
<body>
	<form name="frmPage" method="post" action="<c:url value='/notice/detail.do?noticeNo=${noticeVo.noticeNo}'/>">
	...
	<form id="replyComment" name="replyComment" method="post" action="<c:url value='/notireply/insertComment.do'/>">
			...
			<fieldset>
				<hr style="color: silver;"><br>
					<p style="margin-top: 10px;">
						...
						<input type="text" id="memberId" name="memberId" style="border: none;"  value="${sessionScope.memberId }" readonly>
					</p>
					<input type="hidden" name="notireplyGroupno" value="${noticeVo.noticeNo}">
					<p style="margin-top: 20px;">
						<textarea rows="5" cols="165" name="notireplyContent"></textarea>
					</p>
