...
<fieldset>
    ...
    <div>
        ...
        <span class="sp1">&nbsp;</span>
        <input type="text" name="address" id="address" ReadOnly title="주소"  class="width_350"  style="padding-left: 10px;"><br />
        <span class="sp1">&nbsp;</span>
        <input type="text" name="addressDetail" id="addressDetail" title="상세주소"  class="width_350"  style="padding-left: 10px;">
    </div>
    <div>
