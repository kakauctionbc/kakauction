...
<body>
	...
	<c:if test="${freeVo.prevFreeboardNo!='0' }">
		...
		<a href="<c:url value='/admin/freeboard/updateCount.do?freeboardNo=${freeVo.prevFreeboardNo}'/>">${freeVo.prevFreeboardTitle }</a>
	</c:if>
	<br>
	<c:if test="${freeVo.nextFreeboardNo!='0' }"> 
		...
		<a href="<c:url value='/admin/freeboard/updateCount.do?freeboardNo=${freeVo.nextFreeboardNo}'/>">${freeVo.nextFreeboardTitle }</a>
	</c:if>
