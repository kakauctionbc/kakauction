...
<style>
	...
	<div id="wrap">
		<div id="wrapdiv">
			<form name="frmPage" method="post" action="<c:url value='/admin/member/memberSearch.do'/>">
			...
			<form id="frm1" name="frm1" action="<c:url value='/admin/member/memberSearch.do'/>" method="post">
				<table>
					<tr>
						<th>개인정보<td>
						<td>
					...
					<tr>
						<th>성별</th>
						<td>
							<input type="radio" name="memberGenders" id="memberGenderA" value="">
							<label for="memberGenderA">전체</label> 
							<input type="radio" name="memberGenders" id="memberGender" value="M">
							<label for="memberGender">남자</label> 
							<input type="radio" name="memberGenders" id="memberGender1" value="F">
							<label for="memberGender1">여자</label>
						</td>
					</tr>
				</table>
				<div class="divSearch">
