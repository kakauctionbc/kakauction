...
<body>
	...
	<div class="detailA"> 
		<div>
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture1}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture2}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture3}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture4}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture5}'/>">
		</div>
		<div>
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture6}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture7}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture8}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture9}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture10}'/>">
		</div>
		<div>
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture11}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture12}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture13}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture14}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture15}'/>">
		</div>
		<div>
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture16}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture17}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture18}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture19}'/>">
			<img alt="차량 사진" id="carImage" src="<c:url value='/picture_upload/${acVo.picture20}'/>">
		</div>
	...
	<div class="information mt">
		<dl>
			...
			<dd class="first"> <span class="t">판매자</span>
				...
				<dd> <span class="t">이메일</span> <span class="s">${acVo.memberEmail }</span> </dd>
